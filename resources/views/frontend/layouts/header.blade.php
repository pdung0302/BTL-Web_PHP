                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            ...
                            @endphp
                            <li><i class="ti-headphone-alt"></i>+34 808 7203</li>
                            <li><i class="ti-email"></i> pdung0162@gmail.com </li>
                        </ul>
                    </div>
                    <!--/ End Top Left -->
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            @else
                            <li><i class="fa fa-sign-in"></i><a href="{{route('login.form')}}">Đăng nhập /</a> <a
                                    href="{{route('register.form')}}">Đăng kí</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
