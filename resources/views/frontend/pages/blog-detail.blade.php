...
@section('title','SIMPLE DIMPLE || Blog Detail page')
                ...
                <div class="blog-single-main">
                    <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group button">
                                                    <button type="submit" class="btn"><span
                                                            class="comment_btn comment">Gửi bình luận</span><span
                        ...
                        <p class="text-center p-5">
                            Bạn cần <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">đăng nhập </a> hoặc
                            <a style="color:blue" href="{{route('register.form')}}">đăng kí </a> để đăng nhập.
