                    ...
                    <div class="blog-single-main">
                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Gửi bình luận</span><span class="comment_btn reply" style="display: none;">Reply Comment</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Bạn cần <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">đăng nhập </a> hoặc <a style="color:blue" href="{{route('register.form')}}">đăng kí </a> để đăng nhập.
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">Tin</h3>
                            <div class="letter-inner">
                                <h4>Đăng kí và <br> tin mới nhất.</h4>
