                                    ...
                                    <div class="single-shorter">
                                        ...
                                        <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                            ...
                                            <option value="title" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='title' ) selected @endif>Tên</option>
                                            <option value="price" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='price' ) selected @endif>Giá</option>
                                            <option value="category" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='category' ) selected @endif>Danh mục</option>
                                            <option value="brand" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='brand' ) selected @endif>Thương hiệu</option>
                                        </select>
                                    </div>
                                </div>
                                <ul class="view-mode">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <del style="padding-left:4%;">{{ number_format($original_price, 0) }} VND</del>
                                </div>
                            </div>
                        </div>
                        @endforeach
                        @else
                        <h4 class="text-warning" style="margin:100px auto;">Không còn sản phẩm nào nữa</h4>
                        @endif
