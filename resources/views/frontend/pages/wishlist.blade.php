        ...
        <div class="row">
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        <li><a href="{{('home')}}">Trang chú<i class="ti-arrow-right"></i></a></li>
                ...
                <table class="table shopping-summery">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @php
                            $exchange_rate = 23000;
                            $amount_vnd = $wishlist['amount'] * $exchange_rate;
                            @endphp
                            <td class="total-amount" data-title="Total"><span>{{number_format($amount_vnd, 0)}}
                                    VND</span></td>
                        ...
                        <tr>
                            <td class="text-center">
                                Không có sản phẩm nào. <a href="{{route('product-grids')}}" style="color:blue;">Hãy tiếp
                                    tục mua sắm</a>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-service">
                    <i class="ti-rocket"></i>
                    <h4>Free shiping</h4>
                    <p>Cho đơn hàng trên 100.000 VND</p>
                </div>
                <!-- End Single Service -->
            </div>
            <div class="col-lg-3 col-md-6 col-12">
