                    ...
                    <div class="col-lg-6 col-12">
                        <div class="product-des">
                            ...
                            <div class="short">
                                ...
                                $product_price_vnd = $product_detail->price * $exchangeRate;
                                @endphp

                                <p class="price">
                                    <span class="discount">{{ number_format($after_discount_vnd, 0, ',', '.') }}
                                        VND</span>
                                    <s>{{ number_format($product_price_vnd, 0, ',', '.') }} VND</s>
                                </p>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="comment-review">
                                                    <div class="add-review">
                                                        <h5>Thêm đánh giá</h5>
                                                        <p>Email của bạn sẽ không bị hiển thị</p>
                                                    </div>
                                                    ...
                                                    <div class="review-inner">
                                                        ...
                                                        <p class="text-center p-5">
                                                            Bạn cần <a href="{{route('login.form')}}"
                                                                ...
                                                                style="color:blue"
                                                                href="{{route('register.form')}}">đăng kí</ặc>
                                                ...
                                                <div class="ratting-main">
                                                    <div class="avg-ratting">
                                                        ...
                                                        <span>Dựa trên {{$product_detail->getReview->count()}}
                                                            bình luận</span>
                                                    </div>
                    ...
                    <div class="single-product">
                        <div class="product-img">
                            ...
                            <div class="button-head">
                                <div class="product-action">
                                    ...
                                    <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>So sánh
                                            giá</span></a>
                                </div>
                                <div class="product-action-2">
                                    <a title="Add to cart" href="#">Thêm vào giở hàng</a>
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                            ...
                            <div class="product-price">
                                ...
                                $after_discount_vnd = $after_discount * $exchangeRate;
                                $product_price_vnd = $data->price * $exchangeRate;
                                @endphp

                                <span class="old">{{ number_format($product_price_vnd, 0, ',', '.') }} VND</span>
                                <span>{{ number_format($after_discount_vnd, 0, ',', '.') }} VND</span>
                            </div>
