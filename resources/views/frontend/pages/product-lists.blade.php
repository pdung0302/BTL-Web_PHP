...
@section('title','SIMPLE DIMPLE || PRODUCT PAGE')
    ...
    <section class="product-area shop-sidebar shop-list shop section">
                    ...
                    <ul class="check-box-list">
                        <li>
                            <label class="checkbox-inline" for="1"><input name="news" id="1" type="checkbox">0 -
                                100.000<span class="count">(3)</span></label>
                        </li>
                        <li>
                            <label class="checkbox-inline" for="2"><input name="news" id="2" type="checkbox">100.000 -
                                200.000<span class="count">(5)</span></label>
                        </li>
                        <li>
                            <label class="checkbox-inline" for="3"><input name="news" id="3" type="checkbox">200.000 -
                                500.000<span class="count">(8)</span></label>
                        </li>
                    </ul>
                </div>
                <!--/ End Shop By Price -->
                ...
                <div class="single-widget recent-post">
                    ...
                    <div class="single-post first">
                        ...
                        <div class="content">
                            ...
                            @php
                            $conversion_rate = 23000;
                            $org = ($product->price - ($product->price * $product->discount) / 100) *
                            $conversion_rate;
                            $original_price = $product->price * $conversion_rate;
                            @endphp
                            <p class="price">
                                <del class="text-muted">{{ number_format($original_price, 0) }} VND</del>
                                {{ number_format($org, 0) }} VND
                            </p>
                        </div>
                    </div>
                    <!-- End Single Post -->
        ...
        <div class="col-lg-9 col-md-8 col-12">
            ...
            <div class="row">
                                    ...
                                    <div class="button-head">
                                        <div class="product-action">
                                            <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View"
                                                href="#"><i class=" ti-eye"></i><span>Mua ngay</span></a>
                                        ...
                                        <div class="product-action-2">
                                            <a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}">Thêm
                                                vào giỏ hàng</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="list-content">
                                <div class="product-content">
                                    <div class="product-price">
                                        ...
                                        $after_discount_vnd = $after_discount * $exchangeRate;
                                        $product_price_vnd = $product->price * $exchangeRate;
                                        @endphp
                                        <span>{{ number_format($after_discount_vnd, 0, ',', '.') }}
                                            VND</span>
                                        <del>{{ number_format($product_price_vnd, 0, ',', '.') }} VND</del>
                                    </div>
                                    <h3 class="title"><a
                ...
                @endforeach
                @else
                <h4 class="text-danger" style="margin:100px auto;">Không có sản phẩm bạn đang tìm kiếm.</h4>
                @endif
            </div>
            <div class="row">
                        ...
                        <div class="quickview-content">
                            ...
                            <div class="quickview-ratting-review">
                                ...
                                <div class="quickview-stock">
                                    ...
                                    @else
                                    <span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} hết
                                        hàng</span>
                                    @endif
                                </div>
                            </div>
