    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item {{(($key==0)? 'active' : '')}}">
            ...
            <div class="carousel-caption d-none d-md-block text-left">
                ...
                <a class="btn btn-lg ws-btn wow fadeInUpBig" href="{{route('product-grids')}}" role="button">Mua ngay<i
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-banner">
                    ...
                    <div class="content">
                        <h3>{{$cat->title}}</h3>
                        <a href="{{route('product-cat',$cat->slug)}}">Khám Phá</a>
                    </div>
                </div>
            </div>
            @endif
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="{{route('product-detail', $product->slug)}}">
                                        ...
                                        @if($product->stock <= 0) <span class="out-of-stock">Đã bán</span>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="shop-single-blog">
                    ...
                    <div class="content">
                        ...
                        <a href="{{route('blog.detail',$post->slug)}}" class="more-btn">Tiếp tục</a>
                    </div>
                </div>
                <!-- End Single Blog  -->
            </div>
